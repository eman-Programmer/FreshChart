                    ...
                    >
                      ...
                      <div className="relative">
                        <Input
                          ...
                          className="w-full h-[59.19px] px-4 py-3 pl-12 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-primary-500! focus:ring-2 focus:ring-primary-100! transition-all text-center text-2xl md:text-2xl! tracking-[0.5em] font-mono  placeholder:text-2xl placeholder:font-medium placeholder:text-[#9AA0A8]"
                        />
                        <svg
                          width="20"
                          height="16"
