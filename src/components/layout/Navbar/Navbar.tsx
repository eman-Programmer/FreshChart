          ...
          <div className="container mx-auto px-4!">
            <div className="flex items-center justify-between h-16 lg:h-18 gap-4 lg:gap-8">
              ...
              <div className="flex items-center gap-1 lg:gap-2">
                ...
                {status === "unauthenticated" ? (
                  <Link
                    className="hidden lg:flex items-center gap-2 ml-2 px-5 py-2.5 rounded-full bg-green-600 hover:bg-green-700 text-white text-sm font-semibold transition-colors shadow-sm shadow-primary-600/20"
                    href="/login"
                  >
                    <BiUser className="text-sm" />
                    Sign In
                  ...
                  <div ref={accountRef} className="hidden lg:block relative">
                    ...
                    <div
                      className={`absolute right-0 top-full mt-2 w-64 bg-white border border-gray-100 rounded-2xl shadow-xl transition-all duration-200 origin-top-right ${isAccountOpen ? "opacity-100 scale-100 visible" : "opacity-0 scale-95 invisible"}`}
                    >
