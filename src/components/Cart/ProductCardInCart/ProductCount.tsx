...
export default function ProductCount({ product, setIsLoading }: { product: ProductCart, setIsLoading: (value: boolean) => void }) {
  ...
  return (
    <div className="flex items-center bg-gray-50 rounded-xl p-1 border border-gray-200">
      ...
      <button
        className="h-8 w-8 rounded-lg bg-primary-600 shadow-sm shadow-primary-600/30 flex items-center justify-center text-white hover:bg-primary-700 disabled:opacity-40 disabled:cursor-not-allowed transition-all cursor-pointer"
