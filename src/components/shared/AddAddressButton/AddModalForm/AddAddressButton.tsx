...
export default function AddAddressButton({
  ...
  return isCheckout ? (
    <>
      ...
      <button
        ...
        className="w-full rounded-xl bg-[#F0FDF4] border-2 border-dashed border-[#22C55E] p-4 cursor-pointer"
      >
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-[#22C55E]">
            <svg
              width="20"
              height="16"
              viewBox="0 0 20 16"
  ...
  <>  <button type="button" onClick={() => setIsOpenModal(true)} className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-primary-600 text-white font-semibold hover:bg-primary-700 transition-colors shadow-lg shadow-primary-600/25 cursor-pointer">
      <svg
        data-prefix="fas"
        data-icon="plus"
        className="w-5 h-4"
    ...
    <>
      ...
      <button
        onClick={() => setIsOpenModal(true)}
        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary-600 text-white font-semibold hover:bg-primary-700 transition-colors shadow-lg shadow-primary-600/25 cursor-pointer"
      >
        <svg
          width="18"
          height="14"
