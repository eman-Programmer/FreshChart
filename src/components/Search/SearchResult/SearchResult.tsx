      ...
      <main className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-1 bg-white rounded-lg border border-gray-200 p-1">
              <button
                ...
                className={`p-2 rounded-md transition-colors ${view === "grid" ? "bg-primary-600 text-white" : "text-gray-500 hover:text-gray-700"} cursor-pointer`}
              >
                <svg
                  width="20"
                  height="24"
              ...
              <button
                ...
                className={`p-2 rounded-md transition-colors ${view === "list" ? "bg-primary-600 text-white" : "text-gray-500 hover:text-gray-700"} cursor-pointer`}
              >
                <svg
                  width="20"
                  height="24"
        ...
        {isPending ? (
          ...
          <div className="text-center py-20">
            ...
            <button className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-primary-600 text-white font-semibold hover:bg-primary-700 transition-colors cursor-pointer">
              Clear Filters
            </button>
          </div>
        ) : (
