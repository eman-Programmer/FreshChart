      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-12">
        ...
        <form onSubmit={handleSubmit(loginSubmit)}>
              ...
              <Field data-invalid={fieldState.invalid} className="gap-2 mb-6">
                ...
                <div className="relative">
                  <Input
                    ...
                    autoComplete="on"
                    className="h-13 py-3 px-4 pl-12 text-[16px]! font-medium text-[#364153] border-2 border-gray-200 rounded-xl focus:outline-none focus:border-primary-500! focus:ring-2! focus:ring-primary-100! placeholder:text-[16px] placeholder:font-medium placeholder:text-[#9AA0A8] transition-all"
                  />
                  <svg
                    width="20"
                    height="16"
          ...
          <Button
            ...
            className="w-full h-13.25 bg-green-600 text-white py-3 px-4 rounded-xl hover:bg-green-700 transition-all duration-200 font-semibold text-lg shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
          >
            {isSubmitting && (
