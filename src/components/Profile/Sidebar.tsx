...
export default function Sidebar() {
  ...
  const [, setActiveBtn] = useState("addresses");
  return (
    <aside className="w-full lg:w-72 shrink-0">
      <nav className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <ul className="p-2">
          <li>
            <Link
              className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group ${pathName === "/profile/addresses" ? "bg-primary-50 text-primary-700" : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"}`}
              href="/profile/addresses"
              onClick={() => setActiveBtn("addresses")}
            >
              <div
                className={`w-9 h-9 rounded-lg flex items-center justify-center transition-colors ${pathName === "/profile/addresses" ? "bg-primary-500 text-white" : "bg-gray-100 text-gray-500 group-hover:bg-gray-200"}`}
              >
                <svg
                  width="18"
                  height="15"
          ...
          <li>
            <Link
              className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 group ${pathName === "/profile/settings" ? "bg-primary-50 text-primary-700" : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"}`}
              href="/profile/settings"
              onClick={() => setActiveBtn("settings")}
            >
              <div
                className={`w-9 h-9 rounded-lg flex items-center justify-center transition-colors ${pathName === "/profile/settings" ? "bg-primary-500 text-white" : "bg-gray-100 text-gray-500 group-hover:bg-gray-200"}`}
              >
                <svg
                  width="18"
                  height="15"
