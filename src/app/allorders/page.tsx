        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-1">
            <div className="flex items-center gap-4">
              <span className="bg-linear-to-br from-primary-500 to-primary-600 text-white w-14 h-14 rounded-2xl flex items-center justify-center shadow-lg shadow-primary-600/20">
                <svg
                  width="30"
                  height="24"
                  viewBox="0 0 30 24"
